...
*
* Task: Refactor the given 'eh::Model10' class by means of the "Pimpl Idiom":
*        - Replace the 'ElectricEngineGen1' and 'BatteryGen1' data members with an 'Impl' pointer
*        - Remove all physical dependencies from the <Model10.h> header file
*        - Rework the 'Model10' member functions in the source file
*        - Rethink/Refactor the special member functions of the 'Model10' class
*
**************************************************************************************************/
