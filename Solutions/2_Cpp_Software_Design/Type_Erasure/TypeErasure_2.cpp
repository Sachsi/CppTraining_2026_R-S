...
class Shape
{
 public:
   ...
   Shape( ShapeT shape, DrawStrategy drawer, SerializationStrategy serializer )
      : pimpl_{ std::make_unique<Model<ShapeT,DrawStrategy,SerializationStrategy>>( std::move(shape), std::move(drawer), std::move(serializer) ) }
   {}
 ...
 private:
   ...
   {
      explicit Model( ShapeT shape, DrawStrategy drawer, SerializationStrategy serializer )
