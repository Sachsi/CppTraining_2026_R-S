...
void order_by_firstname( Persons& table )
{
...
void order_by_age( Persons& table )
{
...
void count_children( Persons const& table )
{
...
void simpsons_first( Persons& table )
{
...
void compute_total_age( Persons const& table )
{
...
void last_to_first( Persons& table )
{
...
void fourth_oldest( Persons& table )
{
