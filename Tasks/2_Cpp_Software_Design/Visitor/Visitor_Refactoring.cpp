...
class Circle;     // Forward declaration of the 'Circle' class
class Square;
...
// {
//    public:
//       void visit( Circle const& circle ) const
//       {
//          std::cout << "area of circle: " << circle.radius() * circle.radius() * M_PI << '\n';
//          return circle.radius() * circle.radius() * std::numbers::pi_v<double>;
//       }

//       void visit( Square const& square ) const
//       {
//          std::cout << "area of square: " << square.side() * square.side() << '\n';
